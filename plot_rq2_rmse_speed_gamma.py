...
# Plotting helpers
# =========================
def mean_std_by_param(df: pd.DataFrame, param_col: str, metric_col: str = "rmse") -> pd.DataFrame:
...
def plot_rmse_curve(g: pd.DataFrame, param_col: str, title: str, xlabel: str, out_prefix: str) -> None:
    ...
    print("Saved:", png_path.as_posix())
    print("Saved:", pdf_path.as_posix())
...
def main() -> None:
    ...
    # Only plot S1/S2 for RQ2 (as used in the main paper figures)
